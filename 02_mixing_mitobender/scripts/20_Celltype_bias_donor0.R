...
df <- readRDS(".../mitoFilter_df_annotated.rds")

variants <- readRDS(".../variants_donor0_mitoBender.rds")
...
ggsave(p, file = paste0(output_dir, "Celltype_bias_mitoFilter_donor0.pdf"),
