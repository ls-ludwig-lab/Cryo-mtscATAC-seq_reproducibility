...
#Variant Calling based on Lareau et al. Nature Biotechnology 2021 
#see https://github.com/caleblareau/mtscATACpaper_reproducibility


#input rds file of mgatk output
#for each dataset individually
SE <- readRDS("../../CR-ATAC_mtMask.rds")
