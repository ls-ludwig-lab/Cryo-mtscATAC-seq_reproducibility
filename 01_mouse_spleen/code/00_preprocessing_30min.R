...
setwd(".../FF_30min/data/CR-ATAC_mSpleen_FF_30min_mtMask/outs")
...
multi <- read.table(".../FF_30min/data/ATAC_mSpleen_FF_30min_mtMask/MultipletBarcodes_01.txt", sep = "\t", header = FALSE)
...
# load mgatk output
mito.data <- ReadMGATK(dir = ".../FF_30min/data/mgatk_CR-ATAC_mSpleen_FF_30min_mtMask/final")
